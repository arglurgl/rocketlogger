// modified Adafruit example to be called from main.cpp
...
//#include "flash_config.h" already done in main

extern Adafruit_SPIFlash flash; //declared in main
...
void format_flash() {
  // serial port: wait for it to open before continuing.
  ...
  do {
    Serial.println(F("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"));
    Serial.println(F("This will ERASE ALL DATA on the flash chip and format it with a new filesystem!"));
  ...
  // Done!
  Serial.println(F("Flash chip successfully formatted with new empty filesystem! Please restart board."));
